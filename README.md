...
src/
  ...
  components/
    ...
    cards/              # MetricCard, PrimaryMetrics, SecondaryMetrics
    charts/             # Recharts visualizations (ChartCard, CostOverTime, TokensOverTime, etc.)
    tables/             # ModelEfficiency, RecentDays
    features/           # heatmap, forecast, cache-roi, comparison, anomaly, drill-down, help, pdf, command-palette
...
2. Upload your `ccusage.json` file via the UI (or use the Upload button / Cmd+U)
