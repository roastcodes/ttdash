...
const MODEL_CASES = [
  ...
  { raw: 'gpt-5.4-mini', name: 'GPT-5.4 Mini', provider: 'OpenAI' },
  { raw: 'gpt-5.5-pro', name: 'GPT-5.5 Pro', provider: 'OpenAI' },
  { raw: 'gpt-5.6-sol', name: 'GPT-5.6 Sol', provider: 'OpenAI' },
  { raw: 'gpt-5-6-terra', name: 'GPT-5.6 Terra', provider: 'OpenAI' },
  { raw: 'gpt-5.6-luna::openai', name: 'GPT-5.6 Luna', provider: 'OpenAI' },
  {
    raw: 'gpt-5.6-sol::github-copilot',
    name: 'GPT-5.6 Sol',
    provider: 'GitHub Copilot',
  },
  {
    raw: 'github_copilot/gpt-5.6-terra',
    name: 'GPT-5.6 Terra',
    provider: 'GitHub Copilot',
  },
