...
3. Die Security-Hardening-Basis ist fuer den Default-Loopback-Betrieb gut, aber `TTDASH_ALLOW_REMOTE=1` bleibt ein High-Risk-Betriebsmodus ohne echte Authentifizierung.
