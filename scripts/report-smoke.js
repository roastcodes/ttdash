  ...
  for (const testCase of cases) {
    try {
      ...
      if (!text.includes(generated.meta.filterSummary.viewMode)) {
        throw new Error(
          `PDF text does not contain view mode ${generated.meta.filterSummary.viewMode}`,
        );
      }
      if (!text.includes(generated.text.sections.overview)) {
        throw new Error(
          `PDF text does not contain overview heading ${generated.text.sections.overview}`,
        );
      }
      if (!text.includes(generated.text.sections.interpretation)) {
        throw new Error(
          `PDF text does not contain interpretation heading ${generated.text.sections.interpretation}`,
        );
      }
      if (!text.includes(generated.summaryCards[0].label)) {
        throw new Error(
          `PDF text does not contain summary label ${generated.summaryCards[0].label}`,
        );
      }
      if (generated.insights.items.length > 0 && !text.includes(generated.text.sections.insights)) {
        throw new Error(
          `PDF text does not contain insights heading ${generated.text.sections.insights}`,
        );
      }

      console.log(
        `[ok] ${testCase.name}: ${generated.meta.days} days, ${generated.meta.periods} periods`,
      );
    } catch (error) {
      failures += 1;
